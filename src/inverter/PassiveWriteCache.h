...
// Decide whether an REG_PASSIVE_CTRL write is due.  The register block lives
// in the inverter's non-volatile memory, so identical commands are re-sent
// at most every keepaliveMs.
